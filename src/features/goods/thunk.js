...
export const getGoodAPI = createAsyncThunk('goods/getGoodAPI', async () => {
  const res = await axios.get(
    'https://oxmetal-49832-default-rtdb.asia-southeast1.firebasedatabase.app/sadri.json',
  );
...
export const pathGoodAPI = createAsyncThunk('goods/pathGoodAPI', async (data) => {
  ...
  const res = await axios.patch(
    'https://oxmetal-49832-default-rtdb.asia-southeast1.firebasedatabase.app/sadri/-NsHNN90I1nWU6QkydOP.json',
    data,
  );
...
export const deleteGoodAPI = createAsyncThunk('goods/deleteGoodAPI', async (data) => {
  const res = await axios.delete('http://localhost:5173/goods/' + data);
